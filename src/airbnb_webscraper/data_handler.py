...
class DataHandler():
    ...
    def JSONfiles_toCompleteCSVfile(self, runner_type, chunk_size=1000):
        ...
        csv_output_filename = f'{self.ctx.output_folder}/Airbnb_{self.ctx.location}_{runner_type}_{self.first_entry_date_str}.csv'
        ...
        for i in data['prices']:
            ...
            if price_data:
                ...
                for price in items:
                    ...
                    elif ' x 'in desc:      ## The standard price per night, in format "5 x £50 nights"
